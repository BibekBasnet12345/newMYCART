...
<div class="right-div">
<h3>Enter city</h3>
<input class="input-style " type="text" name="city" value="<%=rs2.getString(8)%>" placeholder="enteraddress"  required>
...
<div class="right-div">
<h3>Pay online on this bibeks@pay.com</h3>
...
<button  class="button" type="submit"> proceed to  generate bill and save
